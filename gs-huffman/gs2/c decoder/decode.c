...
int main(int argc, char *argv[])
{
	...
	fRom = fopen("Golden Sun - The Lost Age (UE).gba", "rb");
	if (!fRom) {
...
u16 GetNextChararacter(u16 * last, u32 * src, u32 * flags)
{
	...
	iterPtr = READU32(0x08060C30);
	iterTreeStart = READU32(0x08060C34);
...
void SetInitials(int id, u16 * last, u32 * rptrSrc, u32 * flags)
{
	...
	*rptrSrc = READU32(0x080A9F54 + (id >> 8) * 8);
	rptrStringLengthTable = READU32(0x080A9F54 + (id >> 8) * 8 + 4);
