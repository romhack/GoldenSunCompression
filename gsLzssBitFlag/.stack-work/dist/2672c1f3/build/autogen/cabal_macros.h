...
/* package bitstream-0.2.0.4 */
#define VERSION_bitstream "0.2.0.4"
#define MIN_VERSION_bitstream(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  2 || \
...
#define CURRENT_PACKAGE_KEY "gsLzs_6ZlkkGaKkNE5ehSkCZZUx3"
